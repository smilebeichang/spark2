...
object JoinTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //3.从端口获取数据创建流
    val lineDStream1: ReceiverInputDStream[String] = ssc.socketTextStream("ecs4", 9999)
    val lineDStream2: ReceiverInputDStream[String] = ssc.socketTextStream("ecs3", 8888)
